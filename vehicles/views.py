...
def index(request):
    ...
    for item in equipments:
        ...
        try:
            ...
            rendered_list+=u"<tr style='width:5%;'><td style='width:340px'>"+item.name+" </td><td style='width:338px'>"+str(v.license_plate)+"</td><td style=\"width:300px\"><a class='table-button' href=\"/vehicles/edit/"+str(v.id)+"/\">Editar</a>  <a class='table-button'  href=\"/vehicles/delete/"+str(v.id)+"/\">Apagar</a><a class='table-button'  href=\"/vehicles/swap/"+str(v.id)+"/\">Remanejar</a><a class='table-button'  href=\"/drivers/"+str(v.id)+"/\">Motoristas</a></td></tr>"
        except:
