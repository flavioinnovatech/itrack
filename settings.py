...
DATABASES = {
    'default': {
        ...
        'HOST': '187.115.25.240',                      # Set to empty string for localhost. Not used with sqlite3.
...
SECRET_KEY = '5cx!b$g%1l#*lm(=y^@s_3*ol$m0o5@h1tgss1r3lk)3$_-(wz'
...
EMAIL_PORT= 587
EMAIL_HOST_USER='aaacec@gmail.com '
EMAIL_HOST_PASSWORD='senha1'
EMAIL_USE_TLS=True
