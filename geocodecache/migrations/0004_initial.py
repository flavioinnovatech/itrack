...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('geocodecache_cachedgeocode', (
            ...
            ('full_address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('administrative_area', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
