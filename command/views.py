...
def index(request):
    ...
    for c in equipments:
        try:
            rendered_list+=u"<tr style='width:5%;'><td style=\"width:100px\">"+c.equipment.name+": </td><td style=\"width:100px\">"+str(c.type)+"</td><td style=\"width:100px\">"+str(c.state)+"</td><td style=\"width:150px\">"+str(c.time_sent)+"</td><td style=\"width:150px\">"+ str(c.time_received)+"</td><td style=\"width:150px\">"+str(c.time_executed)+"</td><td> <a class='table-button'  href=\"/commands/delete/"+str(c.id)+"/\">Apagar</a></td></tr>"
        except:
            pass
